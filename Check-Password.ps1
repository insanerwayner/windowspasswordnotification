...
if ( $timeleft -le $DaysToStart )
	...
	Start-Job -InitializationScript $InitializationScript -ScriptBlock { Check-IfChanged -LockScreenOnPasswordChange $input } -Name CheckIfChanged -InputObject $LockScreenOnPasswordChange
